...
using authorization = Airport.DAL.EF.Helpers.Authorization;
...
namespace Airport.BLL.Services
{
    public class UserService : IUserService
    {
        ...
        private readonly AuthOptions _jwt;

        public UserService(UserManager<ApplicationUser> userManager,
            RoleManager<IdentityRole> roleManager,
            IOptions<AuthOptions> jwt,
        ...
        public async Task<string> RegisterAsync(RegisterModel model)
        {
            ...
            if (userWithSameEmail == null)
            {
                ...
                else
                {
                    ...
                    return $"Failed to register user: {errors}";
                }
        ...
        private async Task<JwtSecurityToken> CreateJwtToken(ApplicationUser user)
        {
            ...
            var jwtSecurityToken = new JwtSecurityToken(
                ...
                claims: claims,
                expires: DateTime.UtcNow.AddMinutes(AuthOptions.DurationInMinutes),
